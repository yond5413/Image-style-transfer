...
export function postprocess_frame(output_tensor: Float32Array, width: number, height: number): Uint8Array;
...
export interface InitOutput {
  ...
  readonly postprocess_frame: (a: any, b: number, c: number) => [number, number, number];
