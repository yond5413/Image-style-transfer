...
export function postprocess_frame(output_tensor: Float32Array, original_frame_pixels: Uint8Array, original_width: number, original_height: number, stylized_width: number, stylized_height: number, strength: number): Uint8Array;
...
export interface InitOutput {
  ...
  readonly postprocess_frame: (a: any, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
